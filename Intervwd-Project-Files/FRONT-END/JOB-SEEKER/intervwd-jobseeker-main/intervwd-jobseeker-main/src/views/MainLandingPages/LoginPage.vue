        ...
        >
          <v-card class="elevation-6" rounded="xl">
            ...
            <div align="center" class="text-center mt-5">
              ...
              <v-img
                width="250"
                src="@/assets/InterVWD1.png"
                class="mx-auto d-block"
              />
              <div class="mt-6 fontsize20px">Job Seeker Account</div>
              ...
              <v-card-text>
                ...
                <v-form ref="EmailRef">
                  <v-text-field
                    ...
                    @keydown.enter.prevent="validateSignIn"
                  ></v-text-field
                ></v-form> </v-card-text
            ...
            <div v-if="SignUp_Pending">
              <v-card-text>
                <v-form ref="SingUpRef">
                  ...
                  <v-card color="#f0fdf4" rounded="lg">
...
export default {
  ...
  async mounted() {
    ...
    if (jobId) {
      ...
      this.$store.commit("SET_JOB_ID", jobId);
    }
    this.CountryList = CountriesList;
    this.signUp.Country = await this.getCurrentCountry();

    console.log("Country", this.$store.getters.get_job_id);
  },
  beforeUnmount() {
    this.cleanupAudio();
  ...
  methods: {
    routeToLanding() {
      window.location.href = "https://www.intervwd.com/";
    },
          ...
          try {
            ...
            if (error.message == "There is already a signed in user.") {
              ...
              if (
                ...
                // this.signUpMethod();
                this.signUp.Email = this.form.email;
