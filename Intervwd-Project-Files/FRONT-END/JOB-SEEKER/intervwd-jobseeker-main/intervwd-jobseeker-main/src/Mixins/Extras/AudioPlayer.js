import { ObjectExt } from "@/Mixins/util/ObjectsExt.js";
const AudioPlayerWorkletUrl = new URL(
  "/public/AudioPlayerProcessor.js",
  import.meta.url
).toString();
...
export class AudioPlayer {
  ...
  async start() {
    this.audioContext = await new AudioContext({ sampleRate: 24000 });
    ...
    this.workletNode = await new AudioWorkletNode(
      this.audioContext,
